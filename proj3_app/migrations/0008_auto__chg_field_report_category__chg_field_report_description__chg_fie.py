...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.incident'
        db.alter_column(u'proj3_app_report', 'incident', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Report.category'
        db.alter_column(u'proj3_app_report', 'category', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Report.description'
        db.alter_column(u'proj3_app_report', 'description', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Report.incident'
        db.alter_column(u'proj3_app_report', 'incident', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Report.precinct'
        db.alter_column(u'proj3_app_report', 'precinct', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Report.resolution'
        db.alter_column(u'proj3_app_report', 'resolution', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'proj3_app.report': {
            ...
            'location': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'long': ('django.db.models.fields.FloatField', [], {}),
            'precinct': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'resolution': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'time': ('django.db.models.fields.TimeField', [], {})
        }
    }
