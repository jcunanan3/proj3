...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Crime_Report'
        db.create_table(u'proj3_app_crime_report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incident', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('dayofweek', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('time', self.gf('django.db.models.fields.TimeField')()),
            ('precinct', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.send_create_signal(u'proj3_app', ['Crime_Report'])


    def backwards(self, orm):
        # Deleting model 'Crime_Report'
        db.delete_table(u'proj3_app_crime_report')
