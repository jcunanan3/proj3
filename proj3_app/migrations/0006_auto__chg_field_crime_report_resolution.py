...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crime_Report.resolution'
        db.alter_column(u'proj3_app_crime_report', 'resolution', self.gf('django.db.models.fields.TextField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Crime_Report.resolution'
        db.alter_column(u'proj3_app_crime_report', 'resolution', self.gf('django.db.models.fields.CharField')(max_length=30))
